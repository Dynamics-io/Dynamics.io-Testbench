...
void Dynamics_IO_Testbench::Compute::VK::Vulkan_test::InitWindow()
{
    glfwInit();
...
void Dynamics_IO_Testbench::Compute::VK::Vulkan_test::InitVK()
{
    createInstance();
    setupDebugMessenger();
    createSurface();
...
void Dynamics_IO_Testbench::Compute::VK::Vulkan_test::MainLoop()
{
    while (!glfwWindowShouldClose(window)) {
        glfwPollEvents();
        drawFrame();
...
bool Dynamics_IO_Testbench::Compute::VK::Vulkan_test::checkValidationLayerSupport()
{
    uint32_t layerCount;
...
std::vector<const char*> Dynamics_IO_Testbench::Compute::VK::Vulkan_test::getRequiredExtensions()
{
...
void Dynamics_IO_Testbench::Compute::VK::Vulkan_test::populateDebugMessengerCreateInfo(VkDebugUtilsMessengerCreateInfoEXT& createInfo)
{
    createInfo = {};
...
void Dynamics_IO_Testbench::Compute::VK::Vulkan_test::createInstance()
{
...
void Dynamics_IO_Testbench::Compute::VK::Vulkan_test::setupDebugMessenger()
{
    if (!enableValidationLayers)
        return;
...
void Dynamics_IO_Testbench::Compute::VK::Vulkan_test::createSurface()
{
...
bool Dynamics_IO_Testbench::Compute::VK::Vulkan_test::isDeviceSuitable(VkPhysicalDevice device)
{
...
Vulkan_test::QueueFamilyIndices Dynamics_IO_Testbench::Compute::VK::Vulkan_test::findQueueFamilies(VkPhysicalDevice device)
{
...
void Dynamics_IO_Testbench::Compute::VK::Vulkan_test::createLogicalDevice()
{
...
Vulkan_test::SwapChainSUpportDetails Dynamics_IO_Testbench::Compute::VK::Vulkan_test::querySwapChainSupport(VkPhysicalDevice device)
{
...
VkSurfaceFormatKHR Dynamics_IO_Testbench::Compute::VK::Vulkan_test::chooseSwapSurfaceFormat(const std::vector<VkSurfaceFormatKHR>& availableFormats)
{
...
VkPresentModeKHR Dynamics_IO_Testbench::Compute::VK::Vulkan_test::chooseSwapPresentMode(const std::vector<VkPresentModeKHR>& availablePresentModes)
{
...
VkExtent2D Dynamics_IO_Testbench::Compute::VK::Vulkan_test::chooseSwapExtent(const VkSurfaceCapabilitiesKHR& capabilities)
{
...
void Dynamics_IO_Testbench::Compute::VK::Vulkan_test::createImageViews()
{
...
void Dynamics_IO_Testbench::Compute::VK::Vulkan_test::createRenderPass()
{
...
void Dynamics_IO_Testbench::Compute::VK::Vulkan_test::createFramebuffers()
{
...
void Dynamics_IO_Testbench::Compute::VK::Vulkan_test::createDepthResources()
{
...
VkFormat Dynamics_IO_Testbench::Compute::VK::Vulkan_test::findSupportedFormat(const std::vector<VkFormat>& candidates, VkImageTiling tiling, VkFormatFeatureFlags features)
{
...
VkFormat Dynamics_IO_Testbench::Compute::VK::Vulkan_test::findDepthFormat()
{
...
void Dynamics_IO_Testbench::Compute::VK::Vulkan_test::createTextureImage()
{
...
void Dynamics_IO_Testbench::Compute::VK::Vulkan_test::createTextureImageView()
{
    VkImageViewCreateInfo viewInfo{};
    viewInfo.sType = VK_STRUCTURE_TYPE_IMAGE_VIEW_CREATE_INFO;
...
void Dynamics_IO_Testbench::Compute::VK::Vulkan_test::createTextureSampler()
{
...
void Dynamics_IO_Testbench::Compute::VK::Vulkan_test::createCommandTransferBuffer()
{
    /*VkCommandBufferAllocateInfo allocInfo = Utilities::getCommandBufferAllocateInfo(
        commandPool,
        VK_COMMAND_BUFFER_LEVEL_PRIMARY,
...
void Dynamics_IO_Testbench::Compute::VK::Vulkan_test::recordCommandBuffer(VkCommandBuffer commandBuffer, uint32_t imageIndex)
{
...
void Dynamics_IO_Testbench::Compute::VK::Vulkan_test::drawFrame()
{
...
void Dynamics_IO_Testbench::Compute::VK::Vulkan_test::transitionImageLayout(VkImage image, VkFormat format, VkImageLayout oldLayout, VkImageLayout newLayout)
{
